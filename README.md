...
You should end up with a `ps3` directory that looks like this with the new files you created or modified indicated with asterisks. (Note: I might have made an error, so I will update as needed. Please @ me on Slack if I missed something.)
